...
function updateLocation(encodedQuery, location, stringifyOptions) {
    var encodedSearchString = (0, query_string_1.stringify)(encodedQuery, stringifyOptions);
    ...
    var href = (0, query_string_1.parseUrl)(location.href || '').url + search;
...
function updateInLocation(encodedQueryReplacements, location, stringifyOptions) {
    ...
    var currQuery = (0, query_string_1.parse)(location.search, { parseNumbers: false });
